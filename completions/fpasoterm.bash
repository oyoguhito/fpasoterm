...
_fpasoterm() {
  ...
  case "$prev" in
    ...
    --profile|-p)
      ...
      return
      ;;
    --enable-plugin|--disable-plugin|--plugin-enable|--plugin-disable|--plugin-info)
