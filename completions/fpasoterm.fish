...
complete -c fpasoterm -l plugin-run -r -d 'Invoke a registered plugin command after launch'
complete -c fpasoterm -l plugin-args -r -d 'JSON value passed to plugin-run'
