...
complete -c fpasoterm -l plugin-install-force -d 'Replace an existing plugin during public install'
complete -c fpasoterm -l enable -d 'Enable a plugin downloaded by --plugin-install'
